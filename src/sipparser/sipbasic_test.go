...
func TestEscape(t *testing.T) {
	...
	wanted := []struct {
		...
		{"IsSipWord", IsSipWord},
		{"IsSipUnreserved", IsSipUnreserved},
		{"IsSipReserved", IsSipReserved},
		{"IsSipQuotedPair", IsSipQuotedPair},
		{"IsSipQuotedString", IsSipQuotedString},
		{"IsSipComment", IsSipComment},
		{"IsSipUser", IsSipUser},
		{"IsSipPassword", IsSipPassword},
		{"IsSipParamChar", IsSipParamChar},
		{"IsSipHeaderChar", IsSipHeaderChar},
		{"IsSipUric", IsSipUric},
		{"IsSipUricNoSlash", IsSipUricNoSlash},
		{"IsSipPchar", IsSipPchar},
		{"IsSipScheme", IsSipScheme},
		{"IsSipRegName", IsSipRegName},
